...
ds_collections = {
    'vqav2_val': {
        'train': 'playground/data/eval/vqav2/vqav2_train.jsonl',
        'test': 'playground/data/eval/vqav2/vqav2_val.jsonl',
        'question': 'playground/data/eval/vqav2/v2_OpenEnded_mscoco_val2014_questions.json',
        'annotation': 'playground/data/eval/vqav2/v2_mscoco_val2014_annotations.json',
        'metric': 'vqa_score',
        'max_new_tokens': 10,
    },
    'vqav2_testdev': {
...
if __name__ == '__main__':
    ...
    if ds_collections[args.dataset]['metric'] == 'vqa_score':
        ...
        results = vqa.loadRes(
            resFile=args.results_file,
            quesFile=ds_collections[args.dataset]['question'])
        vqa_scorer = VQAEval(vqa, results, n=2)
        quesIds = [ann['question_id'] for ann in results.dataset['annotations']]
